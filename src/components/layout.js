...
query ContactsQuery {
  ...
  return (
    <div className={`flex flex-col min-h-screen font-sans text-gray-900 ${style.mainBackground}`}>
      ...
      <footer className="bg-none">
        <nav className="flex justify-between items-center max-w-6xl p-4 mx-auto text-sm md:p-8" >
